...
import { COMMANDS, MODEL_PATH } from '../constants';

export default function IdleModel({ modelAction, ...props }) {
	const group = useRef();
	...
	useEffect(() => {
		...
		switch (modelAction) {
			case COMMANDS.DANCE:
				actions['Armature.001|mixArmada'].stop();
				actions['Capoera'].play();
				break;
			case COMMANDS.FIGHT:
				actions['Armature.001|mixArmada'].stop();
				actions['Capoera'].play();
